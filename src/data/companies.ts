    ...
    cities: [
      {
        ...
        companies: [
          ...
          { name: 'Credit Suisse', website: getWebsite('Credit Suisse'), city: 'New York City', region: 'North America', type: 'bank' },
    ...
    cities: [
      {
        ...
        companies: [
          ...
          { name: 'Credit Suisse', website: getWebsite('Credit Suisse'), city: 'London', region: 'Europe', type: 'bank' },
      ...
      },
      {
        ...
        companies: [
          ...
          { name: 'Credit Suisse', website: getWebsite('Credit Suisse'), city: 'Zurich', region: 'Europe', type: 'bank' },
    ...
    cities: [
      {
        ...
        companies: [
          ...
          { name: 'Credit Suisse', website: getWebsite('Credit Suisse'), city: 'Hong Kong', region: 'Asia Pacific', type: 'bank' },
