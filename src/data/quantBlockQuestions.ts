...
export const quantBlockQuestions = {
  'mental-calculations': [
    ...
    },
    {
      ...
      answer: "x = 16 (2⁴ = 16)",
      hint: "Convert logarithmic equation to exponential: if log₂(x) = 4, then x = 2⁴",
      difficulty: "easy",
      targetTime: 30,
    },
    {
      id: 11,
      question: "Calculate the partial derivative of f(x,y) = x²y with respect to x",
    ...
    },
    {
      ...
      answer: "1 + x + x²/2 (e^x ≈ 1 + x + x²/2! + ...)",
      hint: "Taylor series: f(x) = f(0) + f'(0)x + f''(0)x²/2! + ...",
      difficulty: "medium",
      targetTime: 60,
    },
    {
    ...
    },
    {
      ...
      answer: "4/3 (E[X²] = ∫₀² x² × (1/2) dx = (1/2) × [x³/3]₀² = (1/2) × (8/3) = 4/3)",
      hint: "For uniform [a,b], E[X²] = ∫ x² × (1/(b-a)) dx",
      difficulty: "medium",
      targetTime: 60,
    },
    {
    ...
    },
    {
      ...
      answer: "y = x² + C (Integrate both sides: ∫dy = ∫2x dx, so y = x² + C)",
    ...
    {
      id: 24,
      question: "Calculate d/dx(ln(x²))",
      answer: "2/x (Using chain rule: d/dx(ln(x²)) = (1/x²) × 2x = 2/x)",
    ...
    {
      id: 28,
      question: "What's ∫₀^π sin(x)dx?",
      answer: "2 (∫₀^π sin(x)dx = [-cos(x)]₀^π = -cos(π) + cos(0) = -(-1) + 1 = 2)",
    ...
    {
      id: 30,
      question: "What's the gradient of f(x,y) = x² + y² at point (1,1)?",
  ...
  'probability-exercises': [
    ...
    },
    {
      ...
      answer: "e^(-λt) (P(X > t) = ∫ₜ^∞ λe^(-λx) dx = e^(-λt))",
      explanation: [
        "Exponential CDF: P(X ≤ t) = 1 - e^(-λt)",
        "P(X > t) = 1 - P(X ≤ t) = 1 - (1 - e^(-λt)) = e^(-λt)",
        "Or integrate PDF: ∫ₜ^∞ λe^(-λx) dx = e^(-λt)",
      ],
